...
const WhatsAppButton = () => {
  const msg = encodeURIComponent("Hello! I would like to place an order with Wilds Cake, Flower & Drink. Could you please send me your current price list and availability?");
  return (
    <a
